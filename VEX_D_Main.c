...
#pragma config(Motor,  port3,           left_front_drive, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port4,           left_conveyor, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port5,           right_front_drive, tmotorVex393_MC29, openLoop, reversed)
...
#pragma userControlDuration(500)
